...
public class LoginStepDefinitions {
    ...
    public void user_logs_in_as_an_admin_manager() {
        String username = ConfigurationReader.getProperty("adminuser");
        String password = ConfigurationReader.getProperty("salesperson");
    ...
    public void user_verifies_that_page_name_is_displayed(String expected) {
        Assert.assertEquals(expected,  pages.propertiesPage().getPageSubTitle());
    }
